...
description: Implements one plan task tagged `model: sonnet` (UI, styling, docs, fixtures, marketing). Invoked by /task with a task id; works test-first where the task has testable logic and reports back without committing.
model: sonnet
